...
var __WEBPACK_AMD_DEFINE_RESULT__;__webpack_require__(8107);__webpack_require__(8706);__webpack_require__(2008);__webpack_require__(838);__webpack_require__(5832);__webpack_require__(8350);__webpack_require__(4423);__webpack_require__(3792);__webpack_require__(2062);__webpack_require__(4114);__webpack_require__(4490);__webpack_require__(4782);__webpack_require__(6910);__webpack_require__(4554);__webpack_require__(237);__webpack_require__(4743);__webpack_require__(1745);__webpack_require__(6573);__webpack_require__(8100);__webpack_require__(7936);__webpack_require__(739);__webpack_require__(6099);__webpack_require__(3362);__webpack_require__(4864);__webpack_require__(7465);__webpack_require__(7495);__webpack_require__(7745);__webpack_require__(906);__webpack_require__(8781);__webpack_require__(7357);__webpack_require__(9449);__webpack_require__(1699);__webpack_require__(1761);__webpack_require__(5701);__webpack_require__(8156);__webpack_require__(5440);__webpack_require__(5746);__webpack_require__(744);__webpack_require__(1392);__webpack_require__(2762);__webpack_require__(9202);__webpack_require__(3359);__webpack_require__(3500);__webpack_require__(2953);__webpack_require__(3611);/**
 * @license
...
var lodash = __webpack_require__(415);
...
;// CONCATENATED MODULE: ./packages/player/modules/api/entry.js
 ...
 * @type RegExp
 */
var source_origin_regex = /^http[s]?:\/\/(.*[.-])?metascore.philharmoniedeparis.fr/;
...
var API = /*#__PURE__*/function () {
  ...
  return _createClass(API, [{
    key: "postMessage",
    value: function postMessage(method, params) {
    ...
    value: function onLoad(callback) {
      ...
      this.on("ready", function () {
        _this.target.addEventListener("fullscreenchange", _this.onFullscreenChange.bind(_this));
        callback(_this);
      });
    }
    ...
    value: function onMessage(evt) {
      ...
      try {
        ...
        if ("callback" in data && data.callback in this.callbacks) {
          ...
          var params = "params" in data ? data.params : null;
          callback(params);
        }
      } catch (e) {
    ...
    value: function on(type, callback) {
      var callback_id = esm_browser_v4();
      this.callbacks[callback_id] = callback;
      this.postMessage("addEventListener", {
        type: type,
    ...
    key: "play",
    value: function play(inTime, outTime, scenario) {
      if (!isNaN(scenario)) {
        // This is likely a v1 call, alter the parameters for backward compatibility.
        this.postMessage("play", {
          inTime: (0,lodash.round)(inTime / 100, 2),
          outTime: (0,lodash.round)(outTime / 100, 2),
    ...
    key: "page",
    value: function page(block, index) {
    ...
    key: "hideBlock",
    value: function hideBlock(name) {
      this.postMessage("toggleBlock", {
        name: name,
        value: false
      });
      return this;
    ...
    key: "toggleBlock",
    value: function toggleBlock(name) {
      this.postMessage("toggleBlock", {
        name: name
      });
      return this;
    ...
    key: "scenario",
    value: function scenario(value) {
      this.postMessage("scenario", {
        value: value
      });
      return this;
    }
    ...
    key: "responsive",
    value: function responsive(adaptSize, allowUpscaling) {
      this.postMessage("responsiveness", {
        adaptSize,
        allowUpscaling
      });
      return this;
    ...
    value: function toggleFullscreen(value) {
      var enter_fullscreen = typeof value !== "undefined" ? value : !document.fullscreenElement;
      if (enter_fullscreen) {
...
document.addEventListener("DOMContentLoaded", function () {
  var ids = new Set();
  document.querySelectorAll('a[rel="metascore"][data-guide]:not(.metascore-api-processed)').forEach(function (link) {
  ...
  if (ids.size > 0) {
    var callback = function callback(api) {
      var cleanArg = function cleanArg(arg) {
      ...
      var handler = function handler(evt) {
        ...
        for (var i = 0, length = actions.length; i < length; i++) {
          ...
          var fn = action[0];
          if (fn in api) {
            var args = action.length > 1 ? action[1].split(",").map(cleanArg) : [];
            api[fn].apply(api, _toConsumableArray(args));
            evt.preventDefault();
          }
        }
      };
      document.querySelectorAll(`a[rel="metascore"][data-guide="${api.target.id}"]`).forEach(function (link) {
        link.addEventListener("click", handler);
      });
    };
    document.querySelectorAll(`iframe#${Array.from(ids).join(",iframe#")}`).forEach(function (iframe) {
...
//# sourceMappingURL=metaScore.API.umd.js.map