...
/* harmony import */ var blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22098);
...
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_STARTUP_THEN) = "faire %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_STARTUP_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_STARTUP_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_ENTER_FULLSCREEN) = "entrer en mode plein écran";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_ENTER_FULLSCREEN_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_ENTER_FULLSCREEN_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_EXIT_FULLSCREEN) = "quitter le mode plein écran";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_EXIT_FULLSCREEN_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().APP_EXIT_FULLSCREEN_HELPURL) = "";
...
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_CLICK_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_SCENARIO) = "aller au scénario %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_SCENARIO_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_SCENARIO_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY) = {};
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["background-color"] = "couleur de fond";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["background-image"] = "image de fond";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["border-color"] = "couleur de bordure";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["border-width"] = "largeur de bordure";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["hidden"] = "caché";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["loop-duration"] = "durée d’une boucle";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["reversed"] = "inversé";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["text"] = "texte";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["cursor-width"] = "largeur du curseur";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY)["cursor-color"] = "couleur du curseur";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_EMPTY_OPTION) = " -- ";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_PROPERTY_MOCK_TOOLTIP) = "il n’y a actuellement aucun composant dans l’espace de travail qui supporte l’attribut « %2 ».";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_NO_SCENARIO_TOOLTIP) = "il n’y a actuellement aucun scénario dans l’espace de travail";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_NO_BLOCK_TOOLTIP) = "il n’y a actuellement aucun bloc dans l’espace de travail";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_GET_PROPERTY) = "%2 de %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_GET_PROPERTY_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_GET_PROPERTY_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_PROPERTY) = "définir %2 de %1 à %3";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_PROPERTY_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_PROPERTY_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_GET_BLOCK_PAGE) = "page active de %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_GET_BLOCK_PAGE_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_GET_BLOCK_PAGE_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_BLOCK_PAGE) = "aller à la page %2 de %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_BLOCK_PAGE_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().COMPONENTS_SET_BLOCK_PAGE_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED) = "lorsque la touche %1 est appuyée";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_THEN) = "faire %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_ANY) = "n’importe quelle";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_SPACE) = "barre d’espace";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_UP) = "▲";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_DOWN) = "▼";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_RIGHT) = "▶";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().KEYBOARD_KEYPRESSED_LEFT) = "◀";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_EMPTY_OPTION) = "    ";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_CLICK) = "au clic sur l’élément déclencheur %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_CLICK_THEN) = "faire %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_CLICK_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_CLICK_EMPTY_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_CLICK_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_OPEN_URL) = "ouvrir l’url %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_OPEN_URL_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().LINKS_OPEN_URL_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_TIMECODE_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_TIMECODE_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_GET_DURATION) = "durée du média";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_GET_DURATION_TOOLTIP) = "Retourne la durée du média en secondes.";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_GET_DURATION_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_GET_TIME) = "temps du média";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_GET_TIME_TOOLTIP) = "Retourne le temps actuel du média en secondes.";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_GET_TIME_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_SET_TIME) = "définir le temps du média à %1";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_SET_TIME_TOOLTIP) = "Définit le temps du média pour qu’il soit égale à la valeur de l’entrée.";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_SET_TIME_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAYING) = "la lecture est en cours";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAYING_TOOLTIP) = "Retourne vrai si le média est en cours de lecture, faux autrement.";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAYING_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY) = "lancer la lecture";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT) = "%1 lire l’extrait de %2 à %3 %4";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_HIGHLIGHT_LINK) = "Surbrillance auto";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_HIGHLIGHT_LINK_TOOLTIP) = "Mettre le lien en évidence lorsque le temps actuel du média se situe entre ses limites temporelles";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_THEN) = "puis faire";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_THEN_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PLAY_EXCERPT_THEN_HELPURL) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PAUSE) = "suspendre la lecture";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PAUSE_TOOLTIP) = "";
(blockly_msg_fr__WEBPACK_IMPORTED_MODULE_0___default().MEDIA_PAUSE_HELPURL) = "";
...
//# sourceMappingURL=metaScore.Player.umd.blockly-locale-fr.js.map